...
\grado{ }
\laboratorio{ }
\jurado{Dra. Ana Georgina Elias \\%(Universidad Nacional de Tucumán) \\ 
Dra. Graciela Molina \\%(Universidad Nacional de Tucumán)\\
Dr. Benjamín Straube %(Universidad Nacional de Tucumán)
}
...
% Capitulo 2
%\include{marco teorico} % pasé esto a hp greedy por un fallo al cargar las citas. Muy raro todo pero funcionó
\include{hp_greedy}
% Capitulo 3
